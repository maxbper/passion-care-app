...
export default function LoopingImage({ gender, exercise_name }) {
    ...
    const exerciseImages: ExerciseImagesByGender = {
        male: {
            ...
            ball_squeeze: require("../assets/images/exercises/male/ball.mp4"),
            breathing: require("../assets/images/exercises/male/breathing.mp4"),
            ...
            diaphragmatic_breathing: require("../assets/images/exercises/male/breathing.mp4"),
            seated_diaphragmatic_breathing: require("../assets/images/exercises/male/breathing.mp4"),
            hamstring_stretch: require("../assets/images/exercises/male/hamstring_stretch.png"),
            heel_raises: require("../assets/images/exercises/male/heel_raises.mp4"),
            incline_pushup: require("../assets/images/exercises/male/incline_pushup.png"),
            knee_lifts: require("../assets/images/exercises/male/march_place.png"),
            supported_knee_lifts: require("../assets/images/exercises/male/march_place.png"),
            ...
            shoulder_rolls: require("../assets/images/exercises/male/shoulder_roll.mp4"),
            seated_shoulder_rolls: require("../assets/images/exercises/male/shoulder_roll.mp4"),
            neck_mobilization: require("../assets/images/exercises/male/neck_mobilization.mp4"),
            neck_side_stretch: require("../assets/images/exercises/male/neck_side_stretch.png"),
            pinch: require("../assets/images/exercises/male/pinch.mp4"),
            reach_fixed_support: require("../assets/images/exercises/male/reach_support.png"),
            ...
            supported_heel_raises: require("../assets/images/exercises/male/heel_raises.mp4"),
            supported_march_place: require("../assets/images/exercises/male/supported_march.png"),
            assisted_sit_stand: require("../assets/images/exercises/male/sit_stand.png"),
            tandem_walk: require("../assets/images/exercises/male/tandem_walk.mp4"),
            ...
            walking: require("../assets/images/exercises/male/walking.mp4"),
            ...
            seated_hamstring_stretch: require("../assets/images/exercises/male/seated_hamstring_stretch.png"),
            ...
            straight_line_walk: require("../assets/images/exercises/male/walking.mp4"),
            glute_bridge: require("../assets/images/exercises/male/glute_bridge.png"),
            soft_ball_squeeze: require("../assets/images/exercises/male/ball.mp4"),
