        ...
        return (
          <>
            <View style={[styles.container, { marginTop: insets.top + 120 }]}>
                ...
                <TasksModal page={2}/>
                <Block title={t("extra_exercises")} onPress={() => {setShowModal(true)} } />
            </View>
            {showModal && (
                <Pressable style={[styles.modalContainer, {height: Dimensions.get("window").height}]} onPress={() => {setShowModal(false)}}>
